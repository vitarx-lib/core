 ...
 */
export const Text = 'text-node' as unknown as (props: {
  children: string | RefSignal<string>
}) => VNode
 ...
 */
export const Comment = 'comment-node' as unknown as (props: {
  children: RefSignal<string>
}) => VNode
