 ...
 * 文本节点元素名称
 */
export type TextNodeElementName = TEXT_NODE_TYPE
/**
 * 注释节点元素名称
 */
export type CommentNodeElementName = COMMENT_NODE_TYPE
/**
 * 无标签元素名称
 */
 ...
 * 片段节点元素名称
 */
export type FragmentNodeElementName = FRAGMENT_NODE_TYPE
/**
 * 固有的元素标签名
 *
 * 包含了所有HTML元素标签名，如div、span、a等元素
 */
export type HTMLNodeElementName = keyof HTMLElementTagMap
/**
 * 特殊元素
 */
...
export type IntrinsicNodeElement = {
  [K in HTMLNodeElementName]: ElementProperties<HTMLElementTagMap[K]>
} & SpecialNodeElement
