import type { HostNodeElements, NodeElementType, VNode, VNodeTypes } from '../types/index.js'
 ...
 * @returns {NodeElementType<T>} 返回与虚拟节点对应的DOM元素
 * @throws {Error} 如果节点尚未渲染，会抛出错误
 */
export function getNodeElement<T extends VNodeTypes>(node: VNode<T>): NodeElementType<T> {
