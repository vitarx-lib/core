...
import { DEV_INFO_PROP } from '../constants/index.js'
...
export const popNodeDevInfo = (props: AnyRecord): NodeDevInfo | undefined => {
  // 开发模式下的调试信息
  return popProperty(props, DEV_INFO_PROP)
}
/**
 * 从给定的属性对象中获取节点开发信息
 *
...
export const setNodeDevInfo = (props: AnyRecord, devInfo: NodeDevInfo): void => {
  // 导出函数，用于写入节点开发信息
  props[DEV_INFO_PROP] = devInfo // 将开发环境信息对象赋值给属性对象的特定键
}
