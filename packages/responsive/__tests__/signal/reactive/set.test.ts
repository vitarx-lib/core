...
import { ReactiveWeakSet, ReactiveSet } from '../../../src/signal/reactive/set.js'

describe('signal/reactive/set', () => {
  describe('ReactiveWeakSet', () => {
    it('should create a ReactiveWeakSet instance', () => {
      const target = new WeakSet()
      const reactiveWeakSet = new ReactiveWeakSet(target)
      
      expect(reactiveWeakSet).toBeInstanceOf(ReactiveWeakSet)
  ...
  describe('ReactiveSet', () => {
    it('should create a ReactiveSet instance', () => {
      ...
      const reactiveSet = new ReactiveSet(target)
      
      expect(reactiveSet).toBeInstanceOf(ReactiveSet)
    ...
    it('should handle clear operations', () => {
      ...
      expect(triggerSignalSpy).toHaveBeenCalledWith('clear', { key: 'size', oldValue: 3, newValue: 0 })
    })
