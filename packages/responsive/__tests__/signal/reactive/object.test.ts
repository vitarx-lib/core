...
import { ref, signal } from '../../../src/index.js'
import {
  createReactive,
  PropertySignal,
  ReactiveArray,
  ReactiveObject
} from '../../../src/signal/reactive/object.js'

describe('signal/reactive/object', () => {
  describe('PropertySignal', () => {
    it('should create a PropertySignal instance', () => {
      const target = { prop: 42 }
      const propertySignal = new PropertySignal(target, 'prop', true)

      expect(propertySignal).toBeInstanceOf(PropertySignal)
    ...
    it('should unwrap callable signal values', () => {
      const callableSignal = signal(42)
  ...
  describe('ReactiveObject', () => {
    it('should create a ReactiveObject instance', () => {
      const target = { prop: 42 }
      const reactiveObject = new ReactiveObject(target, true)
  ...
  describe('ReactiveArray', () => {
    it('should create a ReactiveArray instance', () => {
      const target = [1, 2, 3]
      const reactiveArray = new ReactiveArray(target, true)
