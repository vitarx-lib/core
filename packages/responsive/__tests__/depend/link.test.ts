...
describe('depend/link', () => {
  describe('createDepLink', () => {
    ...
    it('should properly link multiple dependencies for the same effect', () => {
      ...
      expect((signal1 as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_TAIL]).toBe(link1)
      expect((signal2 as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_HEAD]).toBe(link2)
      expect((signal2 as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_TAIL]).toBe(link2)
    })
  })
  ...
  describe('destroyDepLink', () => {
    it('should properly remove a link from both effect and signal dimensions', () => {
      ...
      // Verify link exists
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_HEAD]).toBe(link)
      expect((signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_HEAD]).toBe(link)

      // Destroy the link
      destroyDepLink(link)

      // Verify link is removed
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_HEAD]).toBeUndefined()
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_TAIL]).toBeUndefined()
      expect((signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_HEAD]).toBeUndefined()
      expect((signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_TAIL]).toBeUndefined()
  ...
  describe('clearEffectDeps', () => {
    it('should remove all dependencies for an effect', () => {
      ...
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_HEAD]).toBeDefined()
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_TAIL]).toBeDefined()
      ...
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_HEAD]).toBeUndefined()
      expect((effect as any)[require('../../src/depend/symbol.ts').EFFECT_DEP_TAIL]).toBeUndefined()
      expect((effect as any)[require('../../src/depend/symbol.ts').DEP_VERSION]).toBeUndefined()
      expect((effect as any)[require('../../src/depend/symbol.ts').DEP_INDEX_MAP]).toBeUndefined()
    })
  })
  ...
  describe('clearSignalEffects', () => {
    it('should remove all effects for a signal', () => {
      ...
      expect((signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_HEAD]).toBeDefined()
      expect((signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_TAIL]).toBeDefined()
