...
describe('depend/trigger', () => {
  describe('triggerSignal', () => {
    it('should trigger all dependent effects', () => {
      ...
      ;(signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_HEAD] = {
        effect: effect2,
    ...
    it('should call triggerOnTrigger in dev mode', async () => {
      ...
      const debugModule = await import('../../src/depend/debug.js')
    ...
    it('should handle signal with no dependencies', () => {
      ...
      ;(signal as any)[require('../../src/depend/symbol.ts').SIGNAL_DEP_HEAD] = undefined
